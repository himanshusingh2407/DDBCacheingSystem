...
public class SocketServer implements Runnable {
	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
                ...
                clients[findClient(ID)].send(new Message("test", "SERVER","TRUE", msg.sender));
            }
                ...
                if(findUserThread(msg.sender) == null){
                    	...
                    	for (int i = 0; i < clientCount; i++){
                   		 clients[i].send(new Message("_ipconfig", "SERVER",sb.toString(), msg.sender));              
                    	}
	...
	if (clientCount < clients.length){  
            ...
            sb.append(":");
            sb.append( socket.toString().substring(13, socket.toString().indexOf(',')));
            sb.append(":");
